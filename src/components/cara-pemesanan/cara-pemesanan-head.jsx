    ...
    <section className="h-[40vh] md:h-[55vh] relative">
      ...
      >
        ...
        <p className="teramo mb-8 md:text-[18px] text-[14px] text-white sm:px-16 lg:px-48 drop-shadow-md ">
          Temukan langkah mudah untuk memesan penginapan terbaik Anda bersama
          kami. Nikmati proses pemesanan yang praktis, cepat, dan aman, sehingga
          liburan atau perjalanan Anda menjadi lebih nyaman dan menyenangkan
          sejak awal.
        </p>
      </div>
    </section>
