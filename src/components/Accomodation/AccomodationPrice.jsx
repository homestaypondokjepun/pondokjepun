            ...
            <section className="space-y-6 ">
                ...
                <article className=" p-4 flex flex-col md:flex-row items-center bg-white shadow-sm">
                    <div className="md:w-2/3 p-4">
                        <h3 className="text-lg  font-semibold tracking-wider">Harga Spesial All Access Homestay</h3>
                        ...
                        <div className="mt-6 bg-[#b58d66] inline-block rounded px-4 py-2 text-white font-bold">IDR 500.000 / Malam</div>
                    </div>
